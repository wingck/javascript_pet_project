...
var gallery = [];
gallery[0] = 'pokemon-bellossom/pokemon-bellossom-doodle.gif';
gallery[1] = 'pokemon-mareep/pokemon-mareep-doodle.gif';
gallery[2] = 'pokemon-gengar/pokemon-gengar-doodle.gif';
gallery[3] = 'pokemon-kadabra/pokemon-kadabra-doodle.gif';
gallery[4] = 'pokemon-gyarados/pokemon-gyarados-doodle.gif';
...
function img(){
	...
	return galleryImg.setAttribute('src', "https://custom-doodle.com/wp-content/uploads/doodle/"+gallery[imageNum]);	
}
